...
- [x] Som kund vill jag kunna slutföra ett köp/lägga en order så att jag kan genomföra mina inköp (stock, osv...)
...
- [x] Som kund vill jag kunna söka efter produkter så att jag snabbt kan hitta specifika varor

### Admin-perspektiv

- [x] Som admin vill jag kunna lägga till nya produkter så att sortimentet kan växa
- [x] Som admin vill jag kunna uppdatera produktinformation så att informationen hålls aktuell
- [x] Som admin vill jag kunna ta bort produkter så att utgående produkter kan rensas bort
- [x] Som admin vill jag kunna se alla ordrar så att jag kan hantera verksamheten

## Utökade funktioner (Välj minst 3-4)

### Kund-perspektiv

- [x] Som kund vill jag kunna lägga till produkter i en varukorg så att jag kan samla mina val innan köp
- [x] Som kund vill jag kunna se min varukorg med totalpris så att jag vet vad jag ska betala
- [?] Som kund vill jag kunna registrera ett konto så att mina uppgifter sparas
- [x] Som kund vill jag kunna logga in så att jag kan komma åt mina uppgifter
- Som kund vill jag kunna sortera produkter (pris, namn, popularitet) så att jag kan hitta bästa erbjudandet
- [x] Som kund vill jag kunna se om en produkt finns i lager så att jag vet om jag kan köpa den
- [x] Som kund vill jag kunna uppdatera antal i varukorgen så att jag kan ändra min beställning
- [x] Som kund vill jag kunna ta bort produkter från varukorgen så att jag kan ångra mig
- [x] Som kund vill jag kunna se orderdetaljer (vilka produkter, antal, pris per vara) så att jag kan granska mitt köp
...
- [x] Som admin vill jag kunna se hur många produkter som finns i lager så att jag kan planera inköp
- [x] Som admin vill jag kunna uppdatera lagersaldo så att informationen är korrekt
...
- [x] Automatisk lagerminskning vid köp
- [x] Blockera köp av produkter som är slutsålda
...
- [x] Environment variables för känslig data
